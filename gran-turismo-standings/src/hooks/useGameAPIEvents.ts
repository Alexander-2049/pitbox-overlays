...
const WEBSOCKET_SERVER_PORT = 49791;
import { GameAPI } from "../utils/GameAPI.ts";

interface Controls {
  throttle?: number;
  brake?: number;
  steeringAnglePercents?: number;
  steeringAnglePercentsMax?: number;
}
 ...
 */
export const useGameAPIEvents = (events: string[]): GameAPIState => {
